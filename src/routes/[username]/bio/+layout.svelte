...
<nav class="flex justify-center my-6">
  <ul class="steps">
    ...
    href="/login/photo"
    class="step"
    class:step-primary={$page.route.id?.includes("photo") || $page.route.id?.includes("bio") || $page.route.id?.includes("edit")}
  >
    Photo
  </a>
  ...
  <a
    ...
    class="step"
    class:step-primary={$page.route.id?.includes("bio") || $page.route.id?.includes("edit")}>Bio</a
  >
  <a
